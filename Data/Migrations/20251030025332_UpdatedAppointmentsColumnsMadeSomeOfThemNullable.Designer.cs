...
namespace CareDev.Data.Migrations
{
    ...
    [Migration("20251030025332_UpdatedAppointmentsColumnsMadeSomeOfThemNullable")]
    partial class UpdatedAppointmentsColumnsMadeSomeOfThemNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CareDev.Models.PatientVitals", b =>
                {
                    ...
                    b.Property<long>("PatientUserId1")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("NurseUserId1");

                    b.HasIndex("PatientUserId1");
            ...
            modelBuilder.Entity("CareDev.Models.PatientVitals", b =>
                {
                    b.HasOne("CareDev.Models.User", "Nurse")
                        .WithMany()
                        .HasForeignKey("NurseUserId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CareDev.Models.User", "Patient")
                        .WithMany()
                        .HasForeignKey("PatientUserId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
