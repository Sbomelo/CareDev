...
namespace CareDev.Controllers
{
    public class AdmissionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdmissionId,AdmissionDate,DischargeDate,AdmissionReason,PatientId,EmployeeId,WardId,BedId,RoomId")] Admission admission)
        {
